...
export default function AdminProjectsPage() {
	const projects = getAdminProjectRows();
	const summaryStats = getAdminProjectSummaryStats();
			...
			<AdminPageHeader
				...
				action={
					<Link
						...
						className="inline-flex items-center gap-2 rounded-xl bg-red-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-red-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600 focus-visible:ring-offset-2"
					>
