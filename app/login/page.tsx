...
//       <p className="text-sm text-gray-500 mb-6">Access the Jimo Command Centre</p>
...
//           type="submit"
//           disabled={isPending}
//           className="w-full bg-[#c8a84b] hover:bg-[#b8962e] text-white font-semibold py-2.5 rounded-lg text-sm transition disabled:opacity-60 disabled:cursor-not-allowed"
//         >
