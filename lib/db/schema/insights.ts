...
export const insights = pgTable("insights", {
	...
	// Tiptap/ProseMirror JSON document — one continuous rich-text body with
	// inline images, headings, links etc. Rendered to HTML on the public
	// site via lib/utils/tiptap-render.ts (generateHTML, server-only).
