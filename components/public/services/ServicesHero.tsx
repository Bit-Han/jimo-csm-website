	...
	return (
		<section className="w-full bg-[#f2f2f2] pt-6 md:pt-8">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				{/* Card */}
				<div className="relative w-full overflow-hidden rounded-2xl bg-white min-h-75 md:min-h-95">
					<div className="grid grid-cols-1 md:grid-cols-2 min-h-75 md:min-h-95">
						{/* Left — Text */}
						...
						{/* Right — Image */}
						<div className="relative order-1 md:order-2 min-h-50 md:min-h-0">
							<Image
