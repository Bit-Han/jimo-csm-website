// //@components/public/projects/ProjectFactsCard
...
export function ProjectFactsCard({
	...
	// Dynamically route to the contact form with current project contextual variables
	const registerInterestHref = `/contact?project=${project.slug}&mode=register`;
