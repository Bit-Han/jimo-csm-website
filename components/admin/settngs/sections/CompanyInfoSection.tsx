// //@/compoenents/admin/settings/sections/CompanyInfoSection.tsx
// "use client";
...
//@/components/admin/settngs/sections/CompanyInfoSection.tsx
"use client";
...
export function CompanyInfoSection({ initialData }: CompanyInfoSectionProps) {
	const [data, setData] = useState<CompanyInfoSettings>(initialData);
	const [saved, setSaved] = useState(false);
	...
	return (
		<div className="flex flex-col gap-8">
			<div>
				<h2 className="text-base font-bold text-ink-950">Company Information</h2>
				<p className="mt-0.5 text-sm text-stone-500">
					These details appear across the public website — the contact page,
					footer, and WhatsApp/phone links.
				</p>
