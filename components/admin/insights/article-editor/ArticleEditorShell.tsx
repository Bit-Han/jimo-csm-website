...
// 	// Client-side mirror of the server's publish guard — purely UX, the
// 	// server action re-checks everything regardless, but this stops
// 	// "an error appeared after I clicked Publish" from ever happening for
// 	// these specific fields.
// 	const missingForPublish = useMemo(
// 		() => computeMissingForPublish(state),
// 		[state],
// 	);
...
// 		if (!canPublish) return; // belt-and-suspenders — buttons that call this are already disabled
...
// 								title={
// 									!canPublish
// 										? `Missing ${joinWithAnd(missingForPublish)}`
// 										: undefined
// 								}
...
// 			{/* Publish-readiness banner — takes priority over the plainer SEO
//           nudge below, since a missing required field blocks publishing
//           outright while a missing SEO field doesn't. */}
