...
// 	// Defensive default: rows saved before the `image` field existed won't have it.
// 	const [data, setData] = useState<HomeAboutSection>({
// 		...initial,
// 		image: initial.image ?? { src: "", alt: "" },
// 	});
...
// 				onChange={(src, alt) => setData((p) => ({ ...p, image: { src, alt } }))}
// 				folder="jimo-property/site-images"
// 				aspectClass="aspect-[4/3]"
// 				hint="Shown beside the About Teaser text on the home page. Recommended: 1000×750px or larger."
// 				required
// 			/>
...
// 						value={data.eyebrow}
// 						onChange={(e) =>
// 							setData((p) => ({ ...p, eyebrow: e.target.value }))
// 						}
// 						className={inputCls}
// 					/>
// 				</div>
...
// 						value={data.heading}
// 						onChange={(e) =>
// 							setData((p) => ({ ...p, heading: e.target.value }))
// 						}
// 						className={inputCls}
// 					/>
// 				</div>
